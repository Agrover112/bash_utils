...
alias git-show-lastn=' bash /home/meow/scripts/gitshowcom.sh' # Look behind at the nth commit back in the log.
...
alias speedread='~/$USER/Downloads/speedread/speedread'
